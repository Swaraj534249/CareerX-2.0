...
const RegisterOrder = () => {
    ...
    const addinpdata = async (e) => {
        ...
        const { orderNo, brand, orderDate, expectedDate, customerName, productCount, orderStatus,country,state,city,zip,bill,ship } = inpVal;

        const res = await fetch("http://localhost:8003/registerOrder", {
            method: "POST",
            headers: {
            ...
            <form className='mt-5'>
                <div className='row'>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 d-none  mb-3">
                        ...
                        <input type="date" onChange={setData} value={inpVal.orderDate = new Date()} name='orderDate' class="form-control" id="exampleInputPassword1" disabled/>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12  mb-3">
                    ...
                    <div class="col-lg-6 col-md-6 col-12  mb-3">
                        ...
                        <select onChange={setData} class="form-select" name='orderStatus' value={inpVal.orderStatus} aria-label="Default select example">
                            <option >Open this select menu</option>
                            <option value={"Confirm"} selected={inpVal.orderStatus == "Confirm"}>Confirm</option>
                            <option value={"Not confirm"} selected={inpVal.orderStatus == "Not confirm"}>Not confirm</option>
                        </select>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12  mb-3">
